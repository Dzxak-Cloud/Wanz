...
let { key } = await akiraa.sendMessage(m.chat, {text: '*🌀 SEDANG MEMBUAT SERVER...*'},{quoted: m})
...
handler.command = handler.help = ['sh','pannel','addgc','delgc','1gb','2gb','3gb','4gb','5gb','6gb','7gb','8gb','unli','delusr','delsrv','listusr','createadmin','listadmin','adminpanel']
handler.tags = ['cpanel']
handler.owner = true
